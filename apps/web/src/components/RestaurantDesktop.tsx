  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.mainContainer}>
        {/* 왼쪽 패널: 레스토랑 목록 */}
        <View style={[styles.leftPanel, { backgroundColor: colors.background, borderRightColor: colors.border }]}>
          ...
          <View style={[styles.rightPanel, { backgroundColor: colors.background }]}>
            <View style={[styles.reviewHeader, { borderBottomColor: colors.border }]}>
              <TouchableOpacity style={styles.backButton} onPress={handleBackToList}>
                <FontAwesomeIcon icon={faArrowLeft} style={{ fontSize: 20, color: colors.text }} />
              </TouchableOpacity>
